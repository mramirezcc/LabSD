...
-- Nodo testigo (participa solo con logs)
...
CREATE TABLE IF NOT EXISTS cuentas (
    ...
    ciudad VARCHAR(50) DEFAULT 'Trujillo',
...
-- Insertar cuentas de ejemplo en Trujillo
INSERT INTO cuentas (numero_cuenta, titular, saldo) 
VALUES ('3001-1111', 'Agroindustria Chicama', 180000.00)
ON CONFLICT (numero_cuenta) DO NOTHING;

INSERT INTO cuentas (numero_cuenta, titular, saldo) 
VALUES ('3001-2222', 'Universidad Nacional de Trujillo', 95000.00)
ON CONFLICT (numero_cuenta) DO NOTHING;
